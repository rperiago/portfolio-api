...
host = os.environ.get('DBAAS_MYSQL_ENDPOINT').split('@')[1].split(':')[0]
user = os.environ.get('DBAAS_MYSQL_USER')
password = os.environ.get('DBAAS_MYSQL_PASSWORD')
port = 3306
db = os.environ.get('DBAAS_MYSQL_ENDPOINT').split('3306/')[1],
